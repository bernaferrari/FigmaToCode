...
export const bodyCopy = "text-pretty leading-[1.7] text-muted-foreground";
...
const buttonVariants = {
  ...
  secondary:
    "border-border bg-white/72 text-site-ink hover:bg-white dark:bg-white/5 dark:hover:bg-white/9",
  inverse:
...
export const home = {
  ...
  heroDescription:
    "mt-6 max-w-2xl text-pretty text-[clamp(1.05rem,1.5vw,1.22rem)] leading-[1.6] text-muted-foreground",
  proofList:
    "mt-6 flex list-none flex-wrap gap-x-5 gap-y-3 p-0 text-[0.78rem] font-[580] text-muted-foreground max-[28rem]:flex-col max-[28rem]:items-start [&_li]:inline-flex [&_li]:items-center [&_li]:gap-1.5 [&_svg]:size-3.5 [&_svg]:stroke-site-green-dark [&_svg]:stroke-2 [&_svg]:[stroke-linecap:round] [&_svg]:[stroke-linejoin:round]",
  manifest:
    "pointer-events-none min-w-0 overflow-hidden rounded-3xl border border-white/10 bg-[oklch(0.14_0.019_154)] text-white shadow-[0_2px_3px_oklch(0_0_0/14%),0_24px_55px_-16px_oklch(0.18_0.04_154/32%),0_54px_110px_-34px_oklch(0.18_0.04_154/25%)] select-none max-[68rem]:w-full max-[68rem]:max-w-2xl",
  manifestToolbar:
    "flex min-h-[4.6rem] items-center gap-3 border-b border-white/10 px-4 [&>div]:flex [&>div]:min-w-0 [&>div]:flex-1 [&>div]:flex-col [&>div]:gap-0.5 [&_strong]:text-[0.78rem] [&_strong]:font-[650] [&>div_span]:text-[0.65rem] [&>div_span]:text-[oklch(0.66_0.015_154)]",
  manifestFileIcon:
    "grid size-9.5 shrink-0 place-items-center rounded-xl border border-white/10 bg-[oklch(0.2_0.02_154)] font-mono text-[0.72rem] font-bold text-[oklch(0.76_0.15_151)]",
  verifiedChip:
    "inline-flex items-center gap-1 rounded-full border border-[oklch(0.7_0.15_151/24%)] bg-[oklch(0.65_0.16_151/9%)] px-2 py-1.5 text-[0.62rem] font-[640] text-[oklch(0.78_0.15_151)] max-md:hidden [&_svg]:size-3 [&_svg]:stroke-current [&_svg]:stroke-2",
  manifestCode:
  ...
  manifestFlow:
    "grid grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-2.5 border-t border-white/10 p-4 text-center text-[0.65rem] text-[oklch(0.72_0.015_154)] max-md:gap-1 max-md:px-3 max-md:py-3 max-md:text-[0.58rem] [&_svg]:w-6 [&_svg]:stroke-[oklch(0.55_0.03_154)] [&_svg]:[stroke-linecap:round] [&_svg]:[stroke-linejoin:round]",
  trustStrip:
    "relative z-2 mx-auto -mt-9 grid w-[min(calc(100%_-_1.5rem),88rem)] grid-cols-1 overflow-hidden rounded-2xl border border-border bg-[oklch(0.995_0.002_145/92%)] shadow-[0_1px_3px_oklch(0.18_0.03_154/5%),0_12px_32px_-18px_oklch(0.18_0.03_154/18%)] backdrop-blur-xl sm:w-[min(calc(100%_-_2.5rem),88rem)] sm:grid-cols-2 lg:grid-cols-4 dark:bg-[oklch(0.17_0.016_154/92%)] dark:shadow-none [&>div]:flex [&>div]:min-h-25 [&>div]:flex-col [&>div]:justify-center [&>div]:gap-1.5 [&>div]:border-t [&>div]:border-border [&>div]:px-[clamp(1rem,3vw,2.5rem)] sm:[&>div]:min-h-30 lg:[&>div]:border-t-0 lg:[&>div+div]:border-l [&_strong]:text-[clamp(1.65rem,3vw,2.35rem)] [&_strong]:font-[660] [&_strong]:tracking-[-0.05em] [&_strong]:text-site-ink [&_strong]:tabular-nums [&_span]:text-[0.72rem] [&_span]:text-muted-foreground",
  privacy:
  ...
  processList:
    "m-0 list-none border-t border-border p-0 [&_li]:grid [&_li]:grid-cols-[2.5rem_1fr] [&_li]:gap-5 [&_li]:border-b [&_li]:border-border [&_li]:py-5 [&_li>span]:text-[0.68rem] [&_li>span]:font-bold [&_li>span]:tracking-[0.08em] [&_li>span]:text-site-green-dark [&_li>span]:tabular-nums [&_h3]:m-0 [&_h3]:text-[0.95rem] [&_h3]:font-[650] [&_h3]:text-site-ink [&_p]:mt-1.5 [&_p]:text-[0.8rem] [&_p]:leading-[1.6] [&_p]:text-muted-foreground",
  comparison:
...
const outputCardBase =
  "relative min-h-88 overflow-hidden rounded-[1.35rem] p-[clamp(1.6rem,3.5vw,2.65rem)] shadow-[0_0_0_1px_oklch(0.18_0.02_154/5%),0_1px_3px_oklch(0.18_0.03_154/5%),0_12px_32px_-18px_oklch(0.18_0.03_154/18%)] dark:shadow-[0_0_0_1px_oklch(1_0_0/8%)] lg:col-span-6 [&_h3]:mt-15 [&_h3]:max-w-[18ch] [&_h3]:text-balance [&_h3]:text-[clamp(1.65rem,3vw,2.6rem)] [&_h3]:leading-[1.02] [&_h3]:font-[640] [&_h3]:tracking-[-0.045em] [&_h3]:text-site-ink [&>p]:mt-4 [&>p]:max-w-2xl [&>p]:text-[0.85rem] [&>p]:leading-[1.65] [&>p]:text-muted-foreground";

const outputCardVariants = {
  web: "[background-color:var(--site-surface)] [background-image:radial-gradient(circle_at_92%_8%,oklch(0.83_0.13_151/52%)_0%,oklch(0.9_0.07_151/24%)_24%,transparent_52%)] dark:[background-image:radial-gradient(circle_at_92%_8%,oklch(0.52_0.12_151/22%)_0%,oklch(0.29_0.06_151/10%)_24%,transparent_54%)] lg:col-span-7",
  tailwind:
    "bg-[oklch(0.18_0.02_154)] text-white lg:col-span-5 [&_h3]:text-white [&>p]:text-[oklch(0.68_0.014_154)]",
  flutter:
    "min-h-76 [background-color:oklch(0.985_0.008_218)] [background-image:radial-gradient(circle_at_90%_100%,oklch(0.82_0.08_218/42%),transparent_48%)] dark:[background-color:oklch(0.18_0.03_218)] dark:[background-image:radial-gradient(circle_at_90%_100%,oklch(0.42_0.1_218/28%),transparent_50%)] lg:col-span-5 [&_h3]:mt-10",
  swiftui:
    "min-h-76 [background-color:oklch(0.988_0.007_61)] [background-image:radial-gradient(circle_at_88%_94%,oklch(0.87_0.12_61/44%),transparent_45%)] dark:[background-color:oklch(0.19_0.03_61)] dark:[background-image:radial-gradient(circle_at_88%_94%,oklch(0.5_0.12_61/25%),transparent_48%)] lg:col-span-7 [&_h3]:mt-10",
} as const;
...
const capabilityBase =
  "min-h-0 rounded-[1.35rem] border border-border p-[clamp(1.6rem,3vw,2.25rem)] min-[68rem]:min-h-108 [&_h3]:mt-13 [&_h3]:max-w-[15ch] [&_h3]:text-[1.35rem] [&_h3]:leading-[1.12] [&_h3]:font-[640] [&_h3]:tracking-[-0.03em] [&_h3]:text-site-ink [&_ul]:mt-6 [&_ul]:flex [&_ul]:list-none [&_ul]:flex-col [&_ul]:gap-3 [&_ul]:p-0 [&_ul]:text-[0.78rem] [&_ul]:leading-[1.45] [&_ul]:text-muted-foreground [&_li]:relative [&_li]:pl-3.5 [&_li]:before:absolute [&_li]:before:top-[0.55em] [&_li]:before:left-0 [&_li]:before:size-1 [&_li]:before:rounded-full [&_li]:before:bg-current";
...
export const editorial = {
  page: `${pageWidth} pt-6`,
  breadcrumbs:
    "flex min-h-12 items-center gap-2 text-[0.7rem] text-muted-foreground [&_a]:text-inherit [&_a]:no-underline [&_a:hover]:text-site-ink",
  article: "mx-auto max-w-[76rem]",
  hero: "max-w-5xl py-[clamp(4.5rem,9vw,8rem)] [&_h1]:m-0 [&_h1]:max-w-[15ch] [&_h1]:text-balance [&_h1]:text-[clamp(3.25rem,6.5vw,6.2rem)] [&_h1]:leading-[0.94] [&_h1]:font-[660] [&_h1]:tracking-[-0.06em] [&_h1]:text-site-ink [&>p:not(:first-child)]:mt-6 [&>p:not(:first-child)]:max-w-3xl [&>p:not(:first-child)]:text-[clamp(1rem,1.5vw,1.15rem)] [&>p:not(:first-child)]:leading-[1.7] [&>p:not(:first-child)]:text-muted-foreground",
  ruledSection: "border-t border-border py-24",
  verdict:
    "border-t border-border py-24 [&>div]:mt-10 [&>div]:grid [&>div]:grid-cols-1 [&>div]:gap-4 md:[&>div]:grid-cols-2 [&_article]:rounded-2xl [&_article]:border [&_article]:border-border [&_article]:bg-white [&_article]:p-6 dark:[&_article]:bg-site-surface [&_article>span]:text-[0.68rem] [&_article>span]:font-[680] [&_article>span]:tracking-[0.07em] [&_article>span]:text-site-green-dark [&_article>span]:uppercase [&_article_p]:mt-4 [&_article_p]:text-[1.1rem] [&_article_p]:leading-[1.55] [&_article_p]:text-site-ink",
  heading: "max-w-4xl",
  tableWrap:
    "mt-10 overflow-x-auto rounded-2xl border border-border bg-white overscroll-x-contain dark:bg-site-surface",
  table:
    "w-full min-w-160 table-fixed border-collapse [&_tr+tr>*]:border-t [&_tr+tr>*]:border-border [&_tr>*]:h-20 [&_tr>*]:w-[36.5%] [&_tr>*]:px-5 [&_tr>*]:py-4 [&_tr>*]:text-left [&_tr>*]:align-middle [&_tr>*]:text-[0.75rem] [&_tr>*]:leading-[1.5] [&_tr>*]:font-[450] [&_tr>*]:text-muted-foreground [&_tr>*:first-child]:w-[27%] [&_tr>*+*]:border-l [&_tr>*+*]:border-border [&_th]:font-[640] [&_th]:text-site-ink [&_thead_tr]:bg-[oklch(0.96_0.006_145)] dark:[&_thead_tr]:bg-[oklch(0.21_0.016_154)] [&_thead_tr>*]:h-14 [&_thead_tr>*]:font-[680] [&_thead_tr>*]:text-site-ink",
  explanation:
    "grid grid-cols-1 gap-12 border-t border-border py-24 min-[68rem]:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] min-[68rem]:gap-[clamp(4rem,9vw,9rem)] [&>div:last-child_p]:m-0 [&>div:last-child_p]:leading-[1.75] [&>div:last-child_p]:text-muted-foreground [&>div:last-child_p+p]:mt-5",
  sourceNote:
    "flex flex-col items-start justify-between gap-6 rounded-2xl border border-border bg-white p-6 dark:bg-site-surface sm:flex-row sm:items-center [&>div]:max-w-3xl [&_span]:text-[0.65rem] [&_span]:font-[680] [&_span]:tracking-[0.07em] [&_span]:text-site-green-dark [&_span]:uppercase [&_strong]:mt-1.5 [&_strong]:block [&_strong]:text-[0.9rem] [&_strong]:text-site-ink [&_p]:mt-2 [&_p]:text-[0.75rem] [&_p]:leading-[1.55] [&_p]:text-muted-foreground [&>a]:group [&>a]:inline-flex [&>a]:shrink-0 [&>a]:items-center [&>a]:gap-1.5 [&>a]:text-[0.72rem] [&>a]:font-[650] [&>a]:text-site-ink [&>a]:no-underline [&_svg]:size-4 [&_svg]:stroke-current [&_svg]:stroke-[1.7]",
  next: "mt-16 mb-16 grid grid-cols-1 gap-10 sm:mt-24 sm:mb-24 min-[68rem]:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] min-[68rem]:gap-20 [&>div:last-child]:border-t [&>div:last-child]:border-border [&_a]:group [&_a]:grid [&_a]:min-h-14 [&_a]:grid-cols-[1fr_auto] [&_a]:items-center [&_a]:gap-3 [&_a]:border-b [&_a]:border-border [&_a]:text-site-ink [&_a]:no-underline [&_a_strong]:text-[0.78rem] [&_a_strong]:font-[640] [&_svg]:size-4 [&_svg]:stroke-current [&_svg]:stroke-[1.7]",

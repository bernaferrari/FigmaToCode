// import { cloneNode } from "./altConversion";
// import { FrameNodeMock } from "./altMixins2";

// // TODO Bernardo see if this is still necessary.
// export const convertGroupToFrame = (node: GroupNode): FrameNode => {
...
//  */
// const updateChildrenXY = (node: SceneNode): SceneNode => {

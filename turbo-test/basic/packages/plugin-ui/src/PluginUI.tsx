  ...
  return (
    <div className="flex flex-col px-2 mt-2 dark:text-white">
          ...
          <button
            className={`w-full p-1 text-sm ${
              selectedNode === tab
                ...
                : "bg-white dark:bg-green-500 dark:bg-opacity-25 border-2 border-green-500 border-opacity-20 dark:text-white dark:border-2 dark:border-green-500 dark:border-opacity-25 rounded hover:text-gray-800 dark:hover:hover:text-gray-200 font-semibold"
            }`}
            onClick={() => {
      ...
      <div className="flex flex-col items-center py-2 bg-gray-50 dark:bg-transparent">
        <div className="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-800">
        ...
        {/* Code View */}
        <span className="w-full p-4 text-xs text-blue-400 bg-emerald-800 rounded">
          {props.code}
        </span>
        <div className="h-2"></div>
  ...
  switch (props.selected) {
    case "HTML":
      return (
        <>
          <div className="flex">
            <svg className="h-16 w-1/4 m-auto" viewBox="0 0 256 361">
              <path
          ...
          <div className="flex space-x-4 mt-2">
            ...
            >
              <button
                className="px-4 py-2 font-semibold text-gray-800 bg-white border

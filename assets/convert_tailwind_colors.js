// Step 1: Remove transparent, black and white from tailwind_colors.

//   transparent: "transparent",
//   black: "#000",
//   white: "#fff",
const tailwind_colors_all = {
  rose: {
    50: "#fff1f2",
    100: "#ffe4e6",
    200: "#fecdd3",
...
const subArr = colorsArr.map((d) => {
  return Object.entries(d[1]).flatMap((e) => {
    obj[e[1]] = d[0] + "-" + e[0];
    return obj;
  });
});
